...
class DashboardScreen extends ConsumerWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                            ...
                            style: GoogleFonts.outfit(
                              ...
                              foreground: Paint()
                                ..shader = const LinearGradient(
                                  colors: [Color(0xFFD4AF37), Color(0xFF9C27B0)], // Gold to Purple
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0x269C27B0), // Purple with 15% opacity (0x26)
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: const Color(0x4D9C27B0), // Purple with 30% opacity (0x4D)
                        width: 1,
                      ),
                    ),
                    child: Row(
              ...
              ).animate().fade(duration: 500.ms, delay: 350.ms).slideX(begin: -0.1, end: 0, duration: 500.ms, delay: 350.ms),
              const SizedBox(height: 16),
          ...
          child: Container(
            ...
            decoration: const BoxDecoration(
              ...
              border: Border.fromBorderSide(
                BorderSide(
                  color: Color(0x4D9C27B0), // Transparent Purple (30% opacity = 0x4D)
                  width: 1.5,
                ),
              ),
            ),
  ...
  Widget _buildHistoryCard(BuildContext context, WidgetRef ref, cvData, int index) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF1C1C1E), // Dark grey background for AMOLED contrast
    ...
    ).animate().fade(duration: 400.ms, delay: (index * 80).ms).slideY(begin: 0.15, end: 0, duration: 400.ms, delay: (index * 80).ms);
  }
  ...
  void _showDeleteConfirmDialog(BuildContext context, WidgetRef ref, int index) {
    showDialog(
      context: context,
      builder: (context) {
        return BackdropFilter(
          ...
          child: AlertDialog(
            ...
            content: Text(
              ...
              style: GoogleFonts.inter(color: const Color(0xFF8E8E93), fontSize: 13, height: 1.4),
            ),
            actions: [
              TextButton(
              ...
              TextButton(
                ...
                child: Text(
                  'Delete',
                  style: GoogleFonts.inter(color: const Color(0xFFE53935), fontWeight: FontWeight.bold),
                ),
              ),
            ],
          ),
...
class _InteractiveCrystal3DState extends State<InteractiveCrystal3D> with SingleTickerProviderStateMixin {
  Object? _crystal;
        ...
        onSceneCreated: (Scene scene) {
          ...
          _controller.addListener(() {
            if (_crystal != null) {
              ...
              _crystal!.mesh.material.diffuse = Vector3(0.83, 0.686, 0.215); // Gold
